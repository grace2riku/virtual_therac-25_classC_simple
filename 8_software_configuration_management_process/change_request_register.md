...
|-------|-------|-------|------|------|------|--------|---------|---------|--------------|--------|----------|
| CR-0001 | 2026-05-15 | 開発者A | MAJOR | CLOSED | GoogleTest 1.17.0 を SOUP-002 として追加し、CppUTest と試験時に選択可能とする(`TH25S_TEST_FRAMEWORK=cpputest\|gtest\|both`)。両フレームワークで同一の 55 試験ケースが走るよう試験ソースを互換マクロ層(`tests/test_framework.h`)経由に統一。製品コード `libth25s_core.a` は不変。 | — | CI-SOUP-002(新規), CI-SRC-002(`CMakeLists.txt`), CI-TD-001〜004, `tests/test_framework.h`(新規) | — (試験ツリー拡張、RCM 影響なし) | main 直接コミット(単独開発・本台帳 1.1 同梱) | UT-001-01〜UT-003-14(両フレームワークで合格) | 2026-05-15 |
...
| 2026-05(リリース後 v1.0.0 保守期) | 1 | 1 | 0 | 0 | 0 | 0 |
