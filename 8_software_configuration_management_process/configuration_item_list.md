...
| CI-DOC-CRR | 変更要求台帳 | `8_software_configuration_management_process/` | 1.20 | 承認済(CR-0001 で 1.1、CR-0002 で 1.2、CR-0003 で 1.3、CR-0004 で 1.4、CR-0005 で 1.5、CR-0006 で 1.6、CR-0007 で 1.7、CR-0008 で 1.8、CR-0009 で 1.9、CR-0010 で 1.10、CR-0011 で 1.11、CR-0012 で 1.12、CR-0013 で 1.13、CR-0014 で 1.14、CR-0015 で 1.15、CR-0016 で 1.16、CR-0017 で 1.17、CR-0018 で 1.18、CR-0019 で 1.19、CR-0020 で 1.20 へ昇格) |
| CI-DOC-CIL | 構成アイテム一覧(本書、自己参照) | `8_software_configuration_management_process/` | 1.20 | 承認済(CR-0001 で 1.1、CR-0002 で 1.2、CR-0003 で 1.3、CR-0004 で 1.4、CR-0005 で 1.5、CR-0006 で 1.6、CR-0007 で 1.7、CR-0008 で 1.8、CR-0009 で 1.9、CR-0010 で 1.10、CR-0011 で 1.11、CR-0012 で 1.12、CR-0013 で 1.13、CR-0014 で 1.14、CR-0015 で 1.15、CR-0016 で 1.16、CR-0017 で 1.17、CR-0018 で 1.18、CR-0019 で 1.19、CR-0020 で 1.20 へ昇格) |
| CI-DOC-SPRP | ソフトウェア問題解決手順書 | `9_software_problem_resolution_process/` | 1.0 | 承認済 |
| CI-DOC-ACL | IEC 62304 監査チェックリスト | `compliance/` | 1.20 | 承認済(CR-0001 で 1.1、CR-0002 で 1.2、CR-0003 で 1.3、CR-0004 で 1.4、CR-0005 で 1.5、CR-0006 で 1.6、CR-0007 で 1.7、CR-0008 で 1.8、CR-0009 で 1.9、CR-0010 で 1.10、CR-0011 で 1.11、CR-0012 で 1.12、CR-0013 で 1.13、CR-0014 で 1.14、CR-0015 で 1.15、CR-0016 で 1.16、CR-0017 で 1.17、CR-0018 で 1.18、CR-0019 で 1.19、CR-0020 で 1.20 へ昇格、§3 対応文書列を章タイトル + アンカーリンク化) |
| CI-DOC-CLAUDE | プロジェクト指示(CLAUDE.md) | `CLAUDE.md` | 1.0 | 承認済 |
| CI-DOC-README | プロジェクト概要(README.md) | `README.md` | 1.0 | 承認済 |
| CI-DOC-STEPS | 開発ステップ記録 / 日割りガイド | `DEVELOPMENT_STEPS.md` | 1.20 | 承認済(CR-0001 で 1.1、CR-0002 で 1.2、CR-0003 で 1.3、CR-0004 で 1.4、CR-0005 で 1.5、CR-0006 で 1.6、CR-0007 で 1.7、CR-0008 で 1.8、CR-0009 で 1.9、CR-0010 で 1.10、CR-0011 で 1.11、CR-0012 で 1.12、CR-0013 で 1.13、CR-0014 で 1.14、CR-0015 で 1.15、CR-0016 で 1.16、CR-0017 で 1.17、CR-0018 で 1.18、CR-0019 で 1.19、CR-0020 で 1.20 へ昇格) |
| CI-DOC-QA | IEC 62304 Q&A 記録(学習プロジェクト固有、CR-0004 で新設) | `IEC62304_QA.md`(文書 ID `QAR-TH25S-001`) | 1.5 | 承認済(CR-0005 で 1.1、CR-0009 で 1.2、CR-0014 で 1.3、CR-0017 で 1.4、CR-0019 で 1.5 へ昇格、QA-005 = 用語・略語の表記ゆれ検出の仕組みの案を追加) |
...
| CI-DOC-ONB | リリース後保守ワークフロー オンボーディングガイド(学習プロジェクト固有、CR-0013 で新設) | `ONBOARDING.md`(文書 ID `ONB-TH25S-001`) | 1.3 | 承認済(CR-0013 で新設、CR-0016 で 1.1(§9 に CR-0013〜0015 追記)、CR-0018 で 1.2(§9 に CR-0016・0017 追記)、CR-0020 で 1.3(§9 に CR-0018・0019 追記)へ昇格) |
...
| BL-20260520-020 | 2026-05-20 | Q&A 教材整備(QA-004 = SDD UNIT-001 th25s_error_t「OK 他 9 種」記載でも実装・テストできた理由を `IEC62304_QA.md` に追記、QAR 1.3 → 1.4) | 開発者A | CR-0017 |
| BL-20260520-021 | 2026-05-20 | プロセス補助文書更新(オンボーディングガイド `ONBOARDING.md` / ONB-TH25S-001 §9 実績に CR-0016・CR-0017 を追記、ONB 1.1 → 1.2) | 開発者A | CR-0018 |
| BL-20260520-022 | 2026-05-20 | Q&A 教材整備(QA-005 = 用語・略語の表記ゆれを検出する仕組みの案を `IEC62304_QA.md` に追記、QAR 1.4 → 1.5) | 開発者A | CR-0019 |
| BL-20260520-023 | 2026-05-20 | プロセス補助文書更新(オンボーディングガイド `ONBOARDING.md` / ONB-TH25S-001 §9 実績に CR-0018・CR-0019 を追記、ONB 1.2 → 1.3) | 開発者A | CR-0020 |
...
| 1.17 | 2026-05-20 | CR-0017 反映: §4 の CI-DOC-QA を 1.3 → 1.4 へ更新(QA-004 = SDD UNIT-001 th25s_error_t の要約記載でも実装・テストできた理由を追加)。CRR/CIL/ACL/STEPS を 1.17 へ昇格に同期。§9 にベースライン BL-20260520-020 を追加。§10 自己参照を 1.17 へ昇格。SOUP・ソースコード・試験資産・要求/試験の実体・SDP/SRS/SAD/SDD/UTPR/ITPR/STPR/SMS/SMP/SRMP/SSC/RMF/SCMP/CCB/SPRP/HZA/UTM/ONB/README/CLAUDE は不変(SDD は QA-004 で改善余地を記録したが本 CR では是正せず据え置き)。 | 開発者A |
| 1.18 | 2026-05-20 | CR-0018 反映: §4 の CI-DOC-ONB を 1.1 → 1.2 へ更新(`ONBOARDING.md` §9 実績に CR-0016・CR-0017 を追記)。CRR/CIL/ACL/STEPS を 1.18 へ昇格に同期。§9 にベースライン BL-20260520-021 を追加。§10 自己参照を 1.18 へ昇格。SOUP・ソースコード・試験資産・要求/試験の実体・SDP/SRS/SAD/SDD/UTPR/ITPR/STPR/SMS/SMP/SRMP/SSC/RMF/SCMP/CCB/SPRP/QA/HZA/UTM/README/CLAUDE は不変。 | 開発者A |
| 1.19 | 2026-05-20 | CR-0019 反映: §4 の CI-DOC-QA を 1.4 → 1.5 へ更新(QA-005 = 用語・略語の表記ゆれを検出する仕組みの案を追加)。CRR/CIL/ACL/STEPS を 1.19 へ昇格に同期。§9 にベースライン BL-20260520-022 を追加。§10 自己参照を 1.19 へ昇格。SOUP・ソースコード・試験資産・要求/試験の実体・CI 設定・SDP/SRS/SAD/SDD/UTPR/ITPR/STPR/SMS/SMP/SRMP/SSC/RMF/SCMP/CCB/SPRP/HZA/UTM/ONB/README/CLAUDE は不変。 | 開発者A |
| 1.20 | 2026-05-20 | CR-0020 反映: §4 の CI-DOC-ONB を 1.2 → 1.3 へ更新(`ONBOARDING.md` §9 実績に CR-0018・CR-0019 を追記)。CRR/CIL/ACL/STEPS を 1.20 へ昇格に同期。§9 にベースライン BL-20260520-023 を追加。§10 自己参照を 1.20 へ昇格。SOUP・ソースコード・試験資産・要求/試験の実体・SDP/SRS/SAD/SDD/UTPR/ITPR/STPR/SMS/SMP/SRMP/SSC/RMF/SCMP/CCB/SPRP/QA/HZA/UTM/README/CLAUDE は不変。 | 開発者A |
