...
|-------|-----------|------|-------------|------|
| CI-DOC-SDP | ソフトウェア開発計画書 | `5.1_software_development_planning/` | 1.0 | 承認済 |
| CI-DOC-SRS | ソフトウェア要求仕様書 | `5.2_software_requirements_analysis/` | 1.0 | 承認済 |
| CI-DOC-SAD | ソフトウェアアーキテクチャ設計書 | `5.3_software_architecture_design/` | 1.0 | 承認済 |
| CI-DOC-SDD | ソフトウェア詳細設計書 | `5.4_software_detailed_design/` | 1.0 | 承認済 |
| CI-DOC-UTPR | ユニットテスト計画書/報告書 | `5.5_software_unit_implementation/` | 1.0 | 承認済 |
...
| CI-DOC-SMS | ソフトウェアマスタ仕様書 | `5.8_software_release/` | 1.0 | 承認済 |
| CI-DOC-SMP | ソフトウェア保守計画書 | `6_software_maintenance_process/` | 1.0 | 承認済 |
| CI-DOC-SRMP | ソフトウェアリスクマネジメント計画書 | `7_software_risk_management_process/` | 1.0 | 承認済 |
...
| CI-DOC-CRR | 変更要求台帳 | `8_software_configuration_management_process/` | 1.0 | 承認済 |
| CI-DOC-CIL | 構成アイテム一覧(本書、自己参照) | `8_software_configuration_management_process/` | 1.0 | 承認済 |
| CI-DOC-SPRP | ソフトウェア問題解決手順書 | `9_software_problem_resolution_process/` | 1.0 | 承認済 |
| CI-DOC-ACL | IEC 62304 監査チェックリスト | `compliance/` | 1.0 | 承認済 |
...
| CI-TOOL-003 | 試験フレームワーク | CppUTest | 4.0 | ユニット・結合・システム試験 |
...
| CI-TD-004 | テストランナー・試験ビルド構成 | `tests/test_main.cpp`, `tests/CMakeLists.txt` | `v1.0.0` |
