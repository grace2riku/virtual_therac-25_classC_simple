...
このガイドは、本プロジェクト(IEC 62304 クラス C 学習プロジェクト)で **リリース後の保守(GitHub Issue 対応)** を引き継ぐ人のためのものです。2026-05-20 に Issue #1〜#6 + #11 を **CR-0006〜CR-0012** として処理した実績に基づいて作成し、以降の保守(本ガイド自身の追加 CR-0013 ほか CR-0014〜0015)も本手順に沿って実施しています。再現可能な手順として §9 に実績を蓄積しています。
