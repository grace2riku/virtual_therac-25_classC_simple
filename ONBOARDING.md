...
| —(内部) | 本書 §9 実績に CR-0016・CR-0017 を追記(導入文を一般化)| CR-0018 | MINOR | #20 |
| —(内部) | QA-005(用語・略語の表記ゆれを検出する仕組みの案)を Q&A 記録に追記 | CR-0019 | MINOR | #21 |
...
| 1.3 | 2026-05-20 | CR-0020 反映: §9 実績に CR-0018(本書 §9 実績更新)・CR-0019(QA-005 追記)を追記。手順本体(§0〜§8)・導入文・学びの一例は不変。 | 開発者A |
